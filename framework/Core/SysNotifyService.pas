...
Type
  ...
  public
    procedure SendNotify(Flags: Integer; Intf: IInterface);virtual;abstract;
  End;
  ////////////////////////////////////////////
  ...
  private
    FNotifyIntf:INotify;
  public
    procedure SendNotify(Flags: Integer; Intf: IInterface);override;
...
procedure TNotifyService.SendNotify(Flags: Integer; Intf: IInterface);
var i:Integer;
...
begin
  ...
  begin
    ...
    try
      NotifyObj.SendNotify(Flags,Intf);
    Except
      on E: Exception do
...
procedure TIntfNotify.SendNotify(Flags: Integer; Intf: IInterface);
begin
  if FNotifyIntf<>nil then
    FNotifyIntf.Notify(Flags,Intf);
end;
...
procedure TIntfNotifyEx.SendNotify(Flags: Integer; Intf: IInterface);
begin
...
procedure TEventNotify.SendNotify(Flags: Integer; Intf: IInterface);
begin
  if Assigned(FNotifyEvent) then
    FNotifyEvent(Flags,Intf);
end;
...
procedure TEventNotifyEx.SendNotify(Flags: Integer; Intf: IInterface);
begin
